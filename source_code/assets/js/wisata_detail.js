...
for(var i=0;i<detail['opening_hours'].length;i++){
	jadwal_detail += '<dt>'+detail['opening_hours'][i]['hari']+'</dt><dd>'+detail['opening_hours'][i]['keterangan']+'</dd>';
}
...
$("#features_detail").html('<h2>Fasilitas</h2><ul class="tags">'+features_detail+'</ul>');
...
$("#jadwal_detail").html(jadwal_detail);
